...
"../app.exe" < pos_06_in.txt > out.txt
fc out.txt pos_06_out.txt

"../app.exe" < pos_07_in.txt > out.txt
fc out.txt pos_07_out.txt

"../app.exe" < pos_08_in.txt > out.txt
fc out.txt pos_08_out.txt

"../app.exe" < pos_09_in.txt > out.txt
fc out.txt pos_09_out.txt

"../app.exe" < pos_10_in.txt > out.txt
fc out.txt pos_10_out.txt

"../app.exe" < pos_11_in.txt > out.txt
